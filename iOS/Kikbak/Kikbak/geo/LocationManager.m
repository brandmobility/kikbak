...
- (void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray *)locations {
    ...
    if (abs(howRecent) < 60.0) {
        ...
        if( [prefs objectForKey:KIKBAK_USER_ID] != nil ){
            ...
            [data setObject:[NSNumber numberWithDouble:37.7706402 ] forKey:@"latitude"];
            [data setObject:[NSNumber numberWithDouble:-122.4029718 ] forKey:@"longitude"];
            
            self.currentLocation = [[CLLocation alloc]initWithLatitude:37.7706402 longitude:-122.4029718];
