...
public class EntityBeanFinderFactoryBean implements ResourceLoaderAware, FactoryBean<Object> {
    ...
    static final int UTF = 1, INTEGER = 3, FLOAT = 4, LONG = 5, DOUBLE = 6, CLASS = 7, STRING = 8, FIELD_REF = 9,
            METHOD_REF = 10, INTERFACE_METHOD_REF = 11, NAME_AND_TYPE = 12;
    ...
    public void setClassNamePattern(String packagePattern) {
        classPattern = "classpath*:" + packagePattern.replace(".", "/") + "/*.class";
    }
