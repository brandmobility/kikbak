...
//	private static final Logger logger = Logger.getLogger(ReadOnlyAccountDAOImpl.class);
	...
	public boolean isGiftAvailable(Long userId, Long offerId) {
	    @SuppressWarnings("unchecked")
	    Collection<Long> ids = sessionFactory.getCurrentSession().createSQLQuery(is_gift_available).setLong(0, userId).setLong(1, offerId).list();
