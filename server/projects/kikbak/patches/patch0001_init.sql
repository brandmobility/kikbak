...
CREATE INDEX merchant_id_key USING BTREE ON `MerchantReward` (merchant_id ASC);
CREATE INDEX location_id_key ON `MerchantReward` (location_id ASC);
CREATE INDEX reward_type_key ON `MerchantReward` (reward_type ASC);
