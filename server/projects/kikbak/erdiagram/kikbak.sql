...
DROP INDEX MERCHANT_ID_KEY ON BRANCH;
DROP INDEX GEO_KEY ON BRANCH;
DROP INDEX ZIPCODE_KEY ON BRANCH;
DROP INDEX FACEBOOK_ID_KEY ON FRIEND;
DROP INDEX DATE_RANGE_KEY ON KIKBAK;
DROP INDEX REDEEMED_DATE_KEY ON KIKBAK;
DROP INDEX MERCHANT_ID_LEY ON KIKBAK;
DROP INDEX LOCATION_ID_KEY ON KIKBAK;
DROP INDEX USER_ID_KEY ON KIKBAK;
DROP INDEX NAME_KEY ON MERCHANT;
DROP INDEX MERCHANT_TYPE_KEY ON MERCHANT;
DROP INDEX MERCHANT_ID_KEY ON REWARD;
DROP INDEX LOCATION_ID_KEY ON REWARD;
DROP INDEX REWARD_TYPE_KEY ON REWARD;
DROP INDEX FACEBOOK_ID_KEY ON SHARING;
DROP INDEX LOCATION_ID_KEY ON SHARING;
DROP INDEX USER_ID_KEY ON USER2FRIEND;
DROP INDEX FACEBOOK_ID_KE ON USERS;
DROP INDEX EMAIL_KEY ON USERS;
DROP INDEX CREATE_DATE_KEY ON USERS;
DROP INDEX GENDER_KEY ON USERS;
...
DROP TABLE MERCHANT;
DROP TABLE REWARD;
DROP TABLE REWARDMULTIPLIER;
DROP TABLE SHARING;
DROP TABLE USER2FRIEND;
DROP TABLE USERS;
