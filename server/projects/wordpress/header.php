...
<![endif]-->
<!-- favicons -->
<link rel="shortcut icon" href="<?php template_directory_uri(); ?>/images/favicon.ico">
<?php
  wp_head();
?>
</head>
...
<section id="header">
  <div class="elevated">
    <div class="container">
	<?php if(is_front_page()) : ?><a href="http://kikbak.me/business/"><div class="header-flag"></div></a><?php endif; ?>
      <div class="row">
        <div class="span12">
          <div id="logo">
<?php
