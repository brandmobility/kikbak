...
public class CropActivity extends ActionBarActivity {
   ...
   * below the limit here to make sure the intent stays below 1MB.We should consider just returning
   * a byte array instead of a Bitmap instance to avoid overhead.
   */
