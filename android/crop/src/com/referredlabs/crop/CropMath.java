...
public class CropMath {
  ...
  /**
   * Returns true iff point (x, y) is within or on the rectangle's bounds. RectF's "contains"
   * function treats points on the bottom and right bound as not being contained.
   * 
  ...
  /**
   * Stretches/Scales/Translates photoBounds to match displayBounds, and and returns an equivalent
   * stretched/scaled/translated cropBounds or null if the mapping is invalid.
   * 
