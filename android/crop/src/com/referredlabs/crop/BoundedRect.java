...
/**
 * Maintains invariant that inner rectangle is constrained to be within the outer, rotated
 * rectangle.
 */
public class BoundedRect {
  ...
  /**
   * Tries to move the inner rectangle by (dx, dy). If this would cause it to leave the bounding
   * rectangle, snaps the inner rectangle to the edge of the bounding rectangle.
   */
  ...
  /**
   * Attempts to resize the inner rectangle. If this would cause it to leave the bounding rect,
   * clips the inner rectangle to fit.
   */
  ...
  /**
   * Attempts to resize the inner rectangle. If this would cause it to leave the bounding rect,
   * clips the inner rectangle to fit while maintaining aspect ratio.
   */
