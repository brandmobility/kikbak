...
public class ShareOptionsFragment3 extends DialogFragment implements OnClickListener {
  ...
  public static ShareOptionsFragment3 newInstance(ClientOfferType offer) {
    ShareOptionsFragment3 dialog = new ShareOptionsFragment3();
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    View v = inflater.inflate(R.layout.fragment_share_options3, container, false);
