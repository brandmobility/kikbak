...
insert into offer (merchant_id, name,        image_url,                                               redeem_limit, tos_url,                                               begin_date, end_date) values 
                  (@id,         'wash',      concat(@server, '/data/mud_puppy/mud_puppy_banner.png'), 10,           concat(@server, '/data/mud_puppy/mud_puppy_tos.html'), now(),      now() + interval 180 day);
