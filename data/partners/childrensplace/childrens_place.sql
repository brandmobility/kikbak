...
insert into offer (merchant_id, name,    image_url,                                                           tos_url,                                                           begin_date, end_date) values 
                  (@id,         'first', concat(@server, '/data/childrens_place/childrens_place_banner.png'), concat(@server, '/data/childrens_place/childrens_place_tos.html'), now(),      now() + interval 180 day);
